...
namespace EvimiKur.UI.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(IProductService productService, ICategoryService categoryService, IValidator<ProductCreateModel> userCreateModelValidator, IMapper mapper = null, IUow uow = null)
        {
